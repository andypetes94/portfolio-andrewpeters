...
- Investigating the relationship between *Rest Defence* and Counterpressing ([1. Counterpressing in Football](#counterpressing-id))
- Developing machine learning methods to analyse passing events ([2. Modelling Passing in Football](#xPT-id))
